...
```bash
java -cp hw2-1.0.0.jar org.ir.crawling.controller.CrawlerController --seed-url-https https://www.latimes.com/ --root data --output-fetch fetch_latimes.csv --output-visit visit_latimes.csv --output-url urls_latimes.csv --output-report CrawlReport_latimes.txt --usc-id 1111417799 --name "Ruchit Bhardwaj" --output-dir output
```
